...
main = hspec $ do
  ...
  describe "Day 22" $ do
    it "solves day22a" $ do
      part22a >>= (`shouldBe` 606484)
    it "solves day22b" $ do
      part22b >>= (`shouldBe` 1162571910364852)

  -- describe "Day 21" $ do
  --   it "solves day21a" $ do
  --     part21a >>= (`shouldBe` 888735)
  --   it "solves day21b" $ do
  --     part21b >>= (`shouldBe` 647608359455719)
  -- describe "Day 20" $ do
  --   it "solves day20a" $ do
  --     part20a >>= (`shouldBe` 4964)
  --   it "solves day20b" $ do
  --     part20b >>= (`shouldBe` 13202)
